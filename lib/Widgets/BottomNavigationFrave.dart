...
import 'package:restaurantee/Screen/Client/ProfileClientPage.dart';
import 'package:restaurantee/Screen/Client/SearchClientPage.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            _ItemButton(
              ...
              text: 'Search',
              onPressed: () => Navigator.pushReplacement(
                  context, routeFrave(page: SearchClientPage())),
            ),
            _ItemButton(
              i: 2,
              index: index,
            ...
            _ItemButton(
              ...
              text: 'Profile',
              onPressed: () => Navigator.pushReplacement(
                  context, routeFrave(page: ProfileClientPage())),
            ),
          ],
        ));
  }
